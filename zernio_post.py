...
def post_photo_slideshow(image_urls, title, description, privacy_level="PUBLIC_TO_EVERYONE",
    ...
    title        : short bolded headline TikTok shows above the caption
                   (max ~90 chars) -- should be DISTINCT from `description`,
                   not the same text repeated, or it visually duplicates.
    description  : the fuller caption text (up to 4000 chars) -- put
                   hashtags here.
